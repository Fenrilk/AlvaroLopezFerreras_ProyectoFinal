 ...
 */
	public Acto() {
		...
		frmJuego.setResizable(false);//Para no modificar el tamaño de la ventana
	 ...
	 * se abre la ventana final donde te indica con  una frase personalizada lo que te pasó.
	...
	private void evento1() {
		...
		//si es igual a 1 entonces se ejecutará la ventana de acto1 donde se mostrará o no se mostrará las armas 
	 ...
	 * Se mostrara en la ventana1 el arma que seleccionaste y aparecerá una frase personalizada
	 */
	 ...
	 * se mostrará el slime y el arma que seleccionaste aparte de la frase personalizada
	 */
